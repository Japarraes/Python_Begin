...
class Book(models.Model):
    ...
    summary = models.TextField(max_length=100, help_text="Indiqua el argumento del libro")
...
class BookInstance(models.Model):
    ...
    imprint = models.CharField(max_length=228)
    ...
    status = models.CharField(max_length=1, choices=LOAN_STAUS, blank=True, default='m', help_text="Disponibilidad del libro")
